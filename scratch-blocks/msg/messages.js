...
Blockly.Msg.COMBINED_MOTOR_MOVEBYYAWANGLE = "%1 combination motor based on yaw angle straight line %2 %3 %4";
...
Blockly.Msg.SENSING_LINEPATROL = 'The linepatrol %1 %2 power is %3 KP %4 KI %5 KD %6';
...
Blockly.Msg.SENSING_CAMERA_FIND_COLOR_BLOCK_Y = '%1 Obtain the y-coordinate system of the current color block';
Blockly.Msg.SENSING_CAMERA_FIND_COLOR_PIXEL = '%1 Get the pixel value of the current color block';
Blockly.Msg.SENSING_CAMERA_MIDDLE_FIND = '%1 Central area color recognition radius %2 R %3 G %4 B %5';
Blockly.Msg.SENSING_CAMERA_MIDDLE_FIND_RED = '%1 Obtain the red value component of the central area';
Blockly.Msg.SENSING_CAMERA_MIDDLE_FIND_GREEN = '%1 Obtain the green value component of the central area';
Blockly.Msg.SENSING_CAMERA_MIDDLE_FIND_BLUE = '%1 Obtain the blue value component of the central area';
Blockly.Msg.SENSING_CAMERA_EXTERN_COLOR = '%1 Global color recognition';
Blockly.Msg.SENSING_CAMERA_EXTERN_RED = '%1 Obtain the red component of the global color';
Blockly.Msg.SENSING_CAMERA_EXTERN_GREEN = '%1 Obtain the green component of the global color';
Blockly.Msg.SENSING_CAMERA_EXTERN_BLUE = '%1 Obtain the blue component of the global color';
Blockly.Msg.SENSING_CAMERA_FIND_LINE = '%1 line patrol';
Blockly.Msg.SENSING_CAMERA_FIND_LINE_STATE = '%1 Obtain the status of the patrol line';
Blockly.Msg.SENSING_CAMERA_FIND_LINE_SHOWSEX = '%1 Obtain the significance of the patrol line';
Blockly.Msg.SENSING_CAMERA_FIND_LINE_RHO = '%1 Obtain the vertical distance value of the patrol line';
Blockly.Msg.SENSING_CAMERA_FIND_LINE_THETA = '%1 Obtain the angle value of the patrol line';
Blockly.Msg.SENSING_CAMERA_NUMBER_CHECK = '%1 Identification Data';
Blockly.Msg.SENSING_CAMERA_NUMBER_STATE = '%1 Get the status of finding numbers';
...
Blockly.Msg.SENSING_CAMERA_FACE_X = '%1 Obtain the X-coordinate value of the face';
Blockly.Msg.SENSING_CAMERA_FACE_Y = '%1 Obtain the Y-coordinate value of the face';
...
Blockly.Msg.SENSING_CAMERA_FACE_TRACE_X = '%1 Obtain the X-coordinate value of face tracking';
Blockly.Msg.SENSING_CAMERA_FACE_TRACE_Y = '%1 Obtain the Y-coordinate value of face tracking';
...
Blockly.Msg.SENSING_CAMERA_APRILTAG_STATE = '%1 Get AprilTag tag recognition status';
Blockly.Msg.SENSING_CAMERA_APRILTAG_ID = '%1 Get the ID value of the AprilTag tag';
Blockly.Msg.SENSING_CAMERA_APRILTAG_X = '%1 Get the X coordinate value of the AprilTag tag';
Blockly.Msg.SENSING_CAMERA_APRILTAG_Y = '%1 Get the Y coordinate value of the AprilTag tag';
Blockly.Msg.SENSING_CAMERA_APRILTAG_ROLL = '%1 Get the angle value of AprilTag tag';
Blockly.Msg.SENSING_CAMERA_APRILTAG_DISTANCE = '%1 Get the distance value of AprilTag tag';
Blockly.Msg.SENSING_CAMERA_CHARACTERISTIC = '%1 Feature point detection';
Blockly.Msg.SENSING_CAMERA_CHARACTERISTIC_STATE = '%1 Obtain the state value of feature detection';
Blockly.Msg.SENSING_CAMERA_CHARACTERISTIC_MATCHINE = '%1 Obtain the matching degree of feature detection';
Blockly.Msg.SENSING_CAMERA_CHARACTERISTIC_ROLL = '%1 Obtain the rotation angle for feature detection';
// Sound blocks
