...
Blockly.Msg.SENSING_CAMER_FIND_LINE_STATE = 'Obtain the status of the patrol line';
Blockly.Msg.SENSING_CAMER_FIND_LINE_SHOWSEX = 'Obtain the significance of the patrol line';
Blockly.Msg.SENSING_CAMER_FIND_LINE_RHO = 'Obtain the vertical distance value of the patrol line';
Blockly.Msg.SENSING_CAMER_FIND_LINE_THETA = 'Obtain the angle value of the patrol line';
Blockly.Msg.SENSING_CAMERA_NUMBER_CHECK = '%1 Identification Data';
Blockly.Msg.SENSING_CAMER_NUMBER_STATE = 'Get the status of finding numbers';
