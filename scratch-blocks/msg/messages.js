...
Blockly.Msg.CONTROL_STOP = "stop and exit";
...
// Event blocks
Blockly.Msg.EVENT_WHENFLAGCLICKED = "%1 When the program starts";
...
Blockly.Msg.MOVEPOWER_COMBINED_MOTOR =
  "Starting at 2% %% power for% 3% 4 movement";
Blockly.Msg.STOPPING_COMBINED_MOTOR =
  "%1 When setting the running motor to stop %2";
Blockly.Msg.COMBINED_MOTOR_STARTWITHPOWER =
  "%1 %2 move with left power %3 %% and right power %4 %%";
Blockly.Msg.COMBINED_MOTOR_STARTWITHPOWEROBJ =
  "%1 %2 moves for %5 seconds with left power %3 %% and right power %4 %%";
...
Blockly.Msg.SPECIFIEDUNIT_MOTOR =
  "%1 %2 %3 rotates at %4%% power for %5 seconds";
Blockly.Msg.STOP_MOTOR = "%1 %2 %3 stop motor";
Blockly.Msg.RELATIVE_POSITION =
  "%1 %2 Set the relative position of the motor %3";
Blockly.Msg.SPECIFIED_MANNER = "%1 %2 %3 When setting the motor to stop %4";
...
Blockly.Msg.COMBINED_MOV_DIR_POWER = "%1 %2 %3 move at power %4 %%";
Blockly.Msg.MOTOR_STARTWITHPOWER = "%1 %2 motor %3 is running at %4%% power";
Blockly.Msg.COMBINED_MOV_DIR_POWER_SECONDS =
...
Blockly.Msg.READ_RETREAT_RIGHT_OFFSET = "%1 %2 Read retreat right offset";
Blockly.Msg.SENSING_REFLECTED_LIGHT_JUDGMENT =
  "%1 %2 The reflected light from grayscale sensor %3 is %4 %5？";
...
Blockly.Msg.SENSING_ISHANDLING = "%1 %2 Is the %3 button of the handle %4";
...
Blockly.Msg.SENSING_LINEPATROLINIT = "%1 %2 Initialize the linepatrol";
...
Blockly.Msg.SENSING_CAMERA_FIND_COLOR_STATE =
  "%1 Get the current search status of the color block";
Blockly.Msg.SENSING_CAMERA_FIND_COLOR_BLOCK_X =
  "%1 Obtain the x-coordinate system of the current color block";
Blockly.Msg.SENSING_CAMERA_FIND_COLOR_BLOCK_Y =
  "%1 Obtain the y-coordinate system of the current color block";
Blockly.Msg.SENSING_CAMERA_FIND_COLOR_PIXEL =
  "%1 Get the pixel value of the current color block";
Blockly.Msg.SENSING_CAMERA_MIDDLE_FIND =
  "%1 Central area color recognition radius %2 R %3 G %4 B %5";
Blockly.Msg.SENSING_CAMERA_MIDDLE_FIND_RED =
  "%1 Obtain the red value component of the central area";
Blockly.Msg.SENSING_CAMERA_MIDDLE_FIND_GREEN =
  "%1 Obtain the green value component of the central area";
Blockly.Msg.SENSING_CAMERA_MIDDLE_FIND_BLUE =
  "%1 Obtain the blue value component of the central area";
Blockly.Msg.SENSING_CAMERA_EXTERN_COLOR = "%1 Global color recognition";
Blockly.Msg.SENSING_CAMERA_EXTERN_RED =
  "%1 Obtain the red component of the global color";
Blockly.Msg.SENSING_CAMERA_EXTERN_GREEN =
  "%1 Obtain the green component of the global color";
Blockly.Msg.SENSING_CAMERA_EXTERN_BLUE =
  "%1 Obtain the blue component of the global color";
Blockly.Msg.SENSING_CAMERA_FIND_LINE = "%1 line patrol";
Blockly.Msg.SENSING_CAMERA_FIND_LINE_STATE =
  "%1 Obtain the status of the patrol line";
Blockly.Msg.SENSING_CAMERA_FIND_LINE_SHOWSEX =
  "%1 Obtain the significance of the patrol line";
Blockly.Msg.SENSING_CAMERA_FIND_LINE_RHO =
  "%1 Obtain the vertical distance value of the patrol line";
Blockly.Msg.SENSING_CAMERA_FIND_LINE_THETA =
  "%1 Obtain the angle value of the patrol line";
Blockly.Msg.SENSING_CAMERA_NUMBER_CHECK = "%1 Identification Data";
Blockly.Msg.SENSING_CAMERA_NUMBER_STATE =
  "%1 Get the status of finding numbers";
Blockly.Msg.SENSING_CAMERA_GET_NUMBER = "%1 Obtain recognized digital content";
...
Blockly.Msg.SENSING_CAMERA_FACE_X =
  "%1 Obtain the X-coordinate value of the face";
Blockly.Msg.SENSING_CAMERA_FACE_Y =
  "%1 Obtain the Y-coordinate value of the face";
Blockly.Msg.SENSING_CAMERA_FACE_TRACE = "%1 face tracking";
Blockly.Msg.SENSING_CAMERA_FACE_TRACE_STATE = "%1 Get facial tracking status";
Blockly.Msg.SENSING_CAMERA_FACE_TRACE_X =
  "%1 Obtain the X-coordinate value of face tracking";
Blockly.Msg.SENSING_CAMERA_FACE_TRACE_Y =
  "%1 Obtain the Y-coordinate value of face tracking";
Blockly.Msg.SENSING_CAMERA_QR_CHECK = "%1 QR code recognition";
Blockly.Msg.SENSING_CAMERA_QR_STATE = "%1 Obtain QR code recognition status";
Blockly.Msg.SENSING_CAMERA_APRILTAG = "%1 AprilTag Tag Tracking";
Blockly.Msg.SENSING_CAMERA_APRILTAG_STATE =
  "%1 Get AprilTag tag recognition status";
Blockly.Msg.SENSING_CAMERA_APRILTAG_ID =
  "%1 Get the ID value of the AprilTag tag";
Blockly.Msg.SENSING_CAMERA_APRILTAG_X =
  "%1 Get the X coordinate value of the AprilTag tag";
Blockly.Msg.SENSING_CAMERA_APRILTAG_Y =
  "%1 Get the Y coordinate value of the AprilTag tag";
Blockly.Msg.SENSING_CAMERA_APRILTAG_ROLL =
  "%1 Get the angle value of AprilTag tag";
Blockly.Msg.SENSING_CAMERA_APRILTAG_DISTANCE =
  "%1 Get the distance value of AprilTag tag";
Blockly.Msg.SENSING_CAMERA_CHARACTERISTIC = "%1 Feature point detection";
Blockly.Msg.SENSING_CAMERA_CHARACTERISTIC_STATE =
  "%1 Obtain the state value of feature detection";
Blockly.Msg.SENSING_CAMERA_CHARACTERISTIC_MATCHINE =
  "%1 Obtain the matching degree of feature detection";
...
Blockly.Msg.SOUND_PLAYMUSIC = "%1 %2 Play note %3 for %4 beats";
//Matrix blocks
Blockly.Msg.MATRIX_LAMP = "%1 %2 light %3";
Blockly.Msg.STOP_MATRIX_LAMP = "%1 %2 turn off pixel lights";
Blockly.Msg.SET_MATRIX_LAMP =
  "%1 %2 set the brightness of the pixel light to %3";
Blockly.Msg.SINGLE_MATRIX_LAMP = "%1 %2 turn on Pixels x %3 y %4 %5";
Blockly.Msg.SET_PIXEL_MATRIX_LAMP = "%1 Turn on the small light %2 x %3 y";
Blockly.Msg.TEXT_MATRIX_LAMP = "%1 %2 text display %3 %4";
...
Blockly.Msg.SET_COLOR_RGB_MATRIX_LAMP =
  "%1 set the light's color is R %2 G %3 B %4";
...
Blockly.Msg.CAMERA_RECOGNITION_DISCERRN_APRLTAG_LAB = "%1 %2 标签是否存在";
Blockly.Msg.CAMERA_RECOGNITION_APRILTAGLAB_ID = "%1 返回%2 标签ID";
Blockly.Msg.CAMERA_RECOGNITION_APRILTAGLAB_X_POINT = "%1 返回%2 标签X坐标";
Blockly.Msg.CAMERA_RECOGNITION_APRILTAGLAB_Y_POINT = "%1 返回%2 标签Y坐标";
Blockly.Msg.CAMERA_RECOGNITION_APRILTAGLAB_ANGLE = "%1 返回%2 标签旋转角度";
Blockly.Msg.CAMERA_RECOGNITION_APRILTAGLAB_CM = "%1 返回%2 标签距离";
Blockly.Msg.CAMERA_RECOGNITION_FIND_MATCH_TARGET = "%1 %2 特征点是否存在";
Blockly.Msg.CAMERA_RECOGNITION_MATCH_TARGET = "%1 返回%2 特征点匹配度";
Blockly.Msg.CAMERA_RECOGNITION_TARGET_ANGLE = "%1 返回%2 特征点旋转角度";
Blockly.Msg.CAMERA_RECOGNITION_DISCERN_FACE = "%1 %2 是否找到人脸";
Blockly.Msg.CAMERA_RECOGNITION_FACE_X_POINT = "%1 返回%2 人脸X坐标";
Blockly.Msg.CAMERA_RECOGNITION_FACE_Y_POINT = "%1 返回%2 人脸Y坐标";
Blockly.Msg.CAMERA_RECOGNITION_FIND_BLACK_LINE = "%1 %2 是否找到黑线";
Blockly.Msg.CAMERA_RECOGNITION_LINE_OFFSET_ANGLE = "%1 返回%2 线段角度";
Blockly.Msg.CAMERA_RECOGNITION_LINE_OFFSET_CM = "%1 返回%2 线段垂距";
Blockly.Msg.CAMERA_RECOGNITION_LINE_SEGMENT_PROMIENT = "%1 返回%2 线段显著性";
Blockly.Msg.CAMERA_RECOGNITION_FOLLOW_BLOCK = "%1 %2 是否找到色块";
Blockly.Msg.CAMERA_RECOGNITION_FOLLOW_BLOCK_SIZE = "%1 返回%2 色块大小";
...
Blockly.Msg.CAMERA_RECOGNITION_SET_MODE_FACE_RECOGNITION =
  "%1 设置%2 人脸识别模式";
Blockly.Msg.CAMERA_RECOGNITION_SET_MODE_FEATUREPOINT_DETECTION =
  "%1 设置%2 特征点检测模式";
