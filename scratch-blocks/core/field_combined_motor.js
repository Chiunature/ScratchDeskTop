 ...
 * @returns
 */
Blockly.FieldCombinedMotor.prototype.createMotorListDom_ = function (
  list,
  side
) {
...
Blockly.FieldCombinedMotor.prototype.createSideDom_ = function (side) {
  ...
  div.setAttribute(
    "class",
    `lls-port-selector__motor lls-port-selector__motor--${side} lls-port-selector__motor--highlight`
  );
...
Blockly.FieldCombinedMotor.prototype.createMototDom_ = function () {
  ...
  selector.setAttribute(
    "class",
    "lls-port-selector lls-port-selector--type-flipper"
  );
  selector.setAttribute(
    "style",
    `background-color: ${this.sourceBlock_.getColour()}`
  );
