 ...
 * stroke="url(#blocklyDisabledPattern8582045930717208)" fill="url(#blocklyDisabledPattern8582045930717208)"
 */
Blockly.Field.prototype.updateEditable = function () {
  ...
  if (this.sourceBlock_.isEditable()) {
    ...
    this.fieldGroup_.children[0].setAttribute("fill-opacity", "0.6");
  }
};
...
Blockly.Field.prototype.updateTextNode_ = function () {
  ...
  // Guard against undefined/null/other non-string values to keep rendering safe.
  // Some dropdowns may provide an undefined initial display value.
  var text = this.text_;
