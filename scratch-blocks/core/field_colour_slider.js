 ...
 * @constructor
 */
Blockly.FieldColourSlider = function (colour, showHue = true, showSaturation = true, showbrightness = true, opt_validator) {
  ...
  this.showHue = showHue;
  this.showSaturation = showSaturation;
  this.showbrightness = showbrightness;
};
...
Blockly.FieldColourSlider.fromJson = function (options) {
  return new Blockly.FieldColourSlider(options['colour'], options['showHue'], options['showSaturation'], options['showbrightness']);
};
