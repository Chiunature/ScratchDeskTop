...
/**
 * String with 35 '0' chars (7 rows × 5 columns).
...
/**
 * String with 35 '1' chars (7 rows × 5 columns).
...
Blockly.FieldMatrix.prototype.updateMatrix_ = function () {
  ...
  // 更新所有35个灯节点
  for (var i = 0; i < 35; i++) {
    var state = i < matrix.length ? matrix[i] : "0";
    if (state === "0") {
