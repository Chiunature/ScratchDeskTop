...
Blockly.cake['motor_starting'] = function (block) {
    ...
    // TODO: Assemble cake into code variable.
    let code = `motor_Starting(${Blockly.cake.toStr(port) ? port : '"' + port + '"'}, ${Blockly.cake.toStr(spin) ? spin : '"' + spin + '"'});\n`;
    return code;
};
...
Blockly.cake['motor_stop'] = function (block) {
    let port = Blockly.cake.valueToCode(block, "PORT", Blockly.cake.ORDER_NONE);
    // TODO: Assemble cake into code variable.
    let code = `motor_Stop(${Blockly.cake.toStr(port) ? port : '"' + port + '"'});\n`;
    return code;
};
...
Blockly.cake['motor_speed'] = function (block) {
    ...
    // TODO: Assemble cake into code variable.
    let code = `motor_Speed(${Blockly.cake.toStr(port) ? port : '"' + port + '"'}, ${Blockly.cake.toStr(speed) ? speed : '"' + speed + '"'});\n`;
    return code;
};
...
Blockly.cake['motor_specifiedunit'] = function (block) {
    ...
    // TODO: Assemble cake into code variable.
    let code = `motor_specifiedunit(${Blockly.cake.toStr(port) ? port : '"' + port + '"'}, ${Blockly.cake.toStr(spin) ? spin : '"' + spin + '"'}, ${Blockly.cake.toStr(count) ? count : '"' + count + '"'}, ${Blockly.cake.toStr(unit) ? unit : '"' + unit + '"'});\n`;
    return code;
};
...
Blockly.cake['motor_specifiedangle'] = function (block) {
    ...
    // TODO: Assemble cake into code variable.
    let code = `motor_Specifiedangle(${Blockly.cake.toStr(port) ? port : '"' + port + '"'}, ${Blockly.cake.toStr(spin) ? spin : '"' + spin + '"'}, ${Blockly.cake.toStr(angle) ? angle : '"' + angle + '"'});\n`;
    return code;
};
...
Blockly.cake['motor_relative_position'] = function (block) {
    ...
    // TODO: Assemble cake into code variable.
    let code = `motor_Relative_Position(${Blockly.cake.toStr(port) ? port : '"' + port + '"'}, ${Blockly.cake.toStr(position) ? position : '"' + position + '"'});\n`;
    return code;
};
...
Blockly.cake['motor_specified_manner'] = function (block) {
    ...
    // TODO: Assemble cake into code variable.
    let code = `motor_specified_manner(${Blockly.cake.toStr(port) ? port : '"' + port + '"'}, ${Blockly.cake.toStr(action) ? action : '"' + action + '"'});\n`;
    return code;
};
...
Blockly.cake['motor_rate'] = function (block) {
    let port = Blockly.cake.valueToCode(block, "PORT", Blockly.cake.ORDER_NONE);
    // TODO: Assemble cake into code variable.
    let code = `motor_rate(${Blockly.cake.toStr(port) ? port : '"' + port + '"'})`;
...
Blockly.cake['motor_angle'] = function (block) {
    let port = Blockly.cake.valueToCode(block, "PORT", Blockly.cake.ORDER_NONE);
    // TODO: Assemble cake into code variable.
    let code = `motor_angle(${Blockly.cake.toStr(port) ? port : '"' + port + '"'})`;
    return [code, Blockly.cake.ORDER_ATOMIC];
};
...
Blockly.cake['motor_position'] = function (block) {
    let port = Blockly.cake.valueToCode(block, "PORT", Blockly.cake.ORDER_NONE);
    // TODO: Assemble cake into code variable.
    let code = `motor_position(${Blockly.cake.toStr(port) ? port : '"' + port + '"'})`;
    return [code, Blockly.cake.ORDER_ATOMIC];
};
...
Blockly.cake['motor_startWithPower'] = function (block) {
    ...
    const code = `motor_startWithPower(${Blockly.cake.toStr(port) ? port : '"' + port + '"'}, ${Blockly.cake.toStr(power) ? power : '"' + power + '"'});\n`;
    return code;
};
