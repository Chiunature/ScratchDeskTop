...
Blockly.Python["operator_random"] = function (block) {
  ...
  var code = "_random.randint(" + arg0 + ", " + arg1 + ")";
...
Blockly.Python["operator_letter_of"] = function (block) {
  ...
  var arg1 =
    Blockly.Python.valueToCode(block, "LETTER", Blockly.Python.ORDER_MEMBER) ||
    "0";
...
Blockly.Python["operator_mathop"] = function (block) {
  ...
  switch (mode) {
    case "_abs_":
      code = "_math.fabs(" + arg0 + ")";
      break;
    case "down_abs":
      code = "_math.floor(" + arg0 + ")";
      break;
    case "up_abs":
      code = "_math.ceil(" + arg0 + ")";
      break;
    case "sqrt_abs":
