...
钟鸣新函数，不确定要不要
 */
Blockly.Blocks["cameraRecognition_changer_camer_mode"] = {
  init: function () {
    this.jsonInit({
      type: "cameraRecognition_changer_camer_mode",
      message0: Blockly.Msg.CAMERA_RECOGNITION_CHANGER_CAMER_MODE,
      args0: [
        {
          type: "field_image",
          src: Blockly.mainWorkspace.options.pathToMedia + "camera.svg",
