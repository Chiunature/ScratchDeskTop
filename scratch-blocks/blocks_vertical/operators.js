      ...
      "args0": [
        {
          ...
          "options": [
            ...
            [Blockly.Msg.OPERATORS_MATHOP_FLOOR, 'down_abs'],
            [Blockly.Msg.OPERATORS_MATHOP_CEILING, 'up_abs'],
            [Blockly.Msg.OPERATORS_MATHOP_SQRT, 'sqrt_abs'],
            [Blockly.Msg.OPERATORS_MATHOP_SIN, 'sin_abs'],
            [Blockly.Msg.OPERATORS_MATHOP_COS, 'cos_abs'],
            [Blockly.Msg.OPERATORS_MATHOP_TAN, 'tan_abs'],
            [Blockly.Msg.OPERATORS_MATHOP_ASIN, 'asin_abs'],
            [Blockly.Msg.OPERATORS_MATHOP_ACOS, 'acos_abs'],
            [Blockly.Msg.OPERATORS_MATHOP_ATAN, 'atan_abs'],
            // [Blockly.Msg.OPERATORS_MATHOP_LN, 'ln_abs'],
            [Blockly.Msg.OPERATORS_MATHOP_LOG, 'ln_abs'],
            [Blockly.Msg.OPERATORS_MATHOP_EEXP, 'e_abs'],
            [Blockly.Msg.OPERATORS_MATHOP_10EXP, '10_abs'],
          ]
        },
        {
          "type": "input_value",
