...
Blockly.Blocks.defaultToolbox =
  ...
  "</block>" +
  '<block type="speed_motor" id="speed_motor">' +
  "</block>" +
  '<block type="specifiedunit_motor" id="specifiedunit_motor">' +
  "</block>" +
  '<block type="specifiedangle_motor" id="specifiedunit_motor">' +
  "</block>" +
  '<block type="relative_position" id="relative_position">' +
  "</block>" +
  '<block type="specified_manner" id="specified_manner">' +
  "</block>" +
  '<block type="rate_motor">' +
  "</block>" +
  '<block type="angle_motor">' +
  "</block>" +
  "</category>" +
  '<category name="%{BKY_CATEGORY_COMBINED_MOTOR}" id="combined_motor" colour="#D65CD6" secondaryColour="#BD42BD">' +
  '<block type="starting_combined_motor" id="starting_combined_motor">' +
  "</block>" +
  '<block type="direction_combined_motor" id="direction_combined_motor">' +
  "</block>" +
  '<block type="speed_combined_motor" id="speed_combined_motor">' +
  "</block>" +
  '<block type="turn_combined_motor" id="turn_combined_motor">' +
  "</block>" +
  '<block type="line_combined_motor" id="line_combined_motor">' +
  "</block>" +
  '<block type="stop_combined_motor" id="stop_combined_motor">' +
  "</block>" +
  '<block type="move_combined_motor" id="move_combined_motor">' +
  "</block>" +
  '<block type="movestep_combined_motor" id="movestep_combined_motor">' +
  "</block>" +
  '<block type="movepower_combined_motor" id="movepower_combined_motor">' +
  "</block>" +
  '<block type="stopping_combined_motor" id="stopping_combined_motor">' +
  "</block>" +
  "</category>" +
  '<category name="%{BKY_CATEGORY_MATRIX}" id="combined_motor" colour="#9966FF" secondaryColour="#774DCB">' +
  '<block type="matrix_lamp" id="matrix_lamp">' +
  "</block>" +
  '<block type="stop_matrix_lamp" id="stop_matrix_lamp">' +
  "</block>" +
  '<block type="set_matrix_lamp" id="set_matrix_lamp">' +
  "</block>" +
  '<block type="single_matrix_lamp" id="single_matrix_lamp">' +
  "</block>" +
  '<block type="text_matrix_lamp" id="text_matrix_lamp">' +
  "</block>" +
  '<block type="setRGB_matrix_lamp" id="setRGB_matrix_lamp">' +
  '<value name="COLOR">' +
  ...
  "</value>" +
  "</block>" +
  '<block type="motion_move9steps" id="motion_move9steps"></block>' +
  ...
  '<block type="sensing_color_judgment" id="sensing_color_judgment"/>' +
  '<block type="sensing_color_detection" id="sensing_color_detection"/>' +
  '<block type="sensing_color_detectionRGB" id="sensing_color_detectionRGB"/>' +
  '<block type="sensing_reflected_light_detection" id="sensing_reflected_light_detection"></block>' +
  '<block type="sensing_grayscale_state" id="sensing_grayscale_state"></block>' +
  '<block type="sensing_line_inspection_judgment" id="sensing_line_inspection_judgment"></block>' +
  '<block type="sensing_ultrasonic_judgment" id="sensing_ultrasonic_judgment"></block>' +
  '<block type="sensing_ultrasonic_detection" id= "sensing_ultrasonic_detection"></block>' +
  '<block type="sensing_sound_intensity" id="sensing_sound_intensity"></block>' +
  '<block type="sensing_key_judgment" id="sensing_key_judgment"></block>' +
  '<block type="sensing_key_press" id="sensing_key_press"></block>' +
  '<block type="sensing_gyroscope_acceleration" id="sensing_gyroscope_acceleration"></block>' +
  '<block type="sensing_gyroscope_attitude" id="sensing_gyroscope_attitude"></block>' +
  '<block type="sensing_magnetic_calibration" id="sensing_magnetic_calibration"></block>' +
  '<block type="sensing_magnetism" id="sensing_magnetism"></block>' +
  '<block type="sensing_compass" id="sensing_compass"></block>' +
  '<block type="sensing_read_pin" id="sensing_read_pin"></block>' +
  '<block type="sensing_write_pin" id="sensing_write_pin"></block>' +
  '<block type="sensing_read_analog" id="sensing_read_analog"></block>' +
  '<block type="sensing_write_analog" id="sensing_write_analog"></block>' +
  '<block type="sensing_timer" id="sensing_timer"></block>' +
