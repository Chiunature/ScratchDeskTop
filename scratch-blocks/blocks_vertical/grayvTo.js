...
Blockly.Blocks["if_all_ch_way_state"] = {
  init: function () {
    this.jsonInit({
      type: "if_all_ch_way_state",
...
Blockly.Blocks["power_find_if_ch_state"] = {
  init: function () {
    this.jsonInit({
      type: "power_find_if_ch_state",
...
Blockly.Blocks["power_find_way_type"] = {
  init: function () {
    this.jsonInit({
      type: "power_find_way_type",
      ...
      args0: [
        ...
        },
        {
          ...
          name: "INTERSECTION",
          options: [
            [Blockly.Msg.GRAYV2_Intersection_1, "0"],
            [Blockly.Msg.GRAYV2_Intersection_2, "1"],
            [Blockly.Msg.GRAYV2_Intersection_3, "2"],
          ],
        },
      ],
      category: Blockly.Categories.grayv2,
...
Blockly.Blocks["power_find_line"] = {
  init: function () {
    this.jsonInit({
      type: "power_find_line",
...
Blockly.Blocks["power_find_line_encord"] = {
  init: function () {
    this.jsonInit({
      type: "power_find_line_encord",
...
Blockly.Blocks["power_find_line_ms"] = {
  init: function () {
    this.jsonInit({
      type: "power_find_line_ms",
