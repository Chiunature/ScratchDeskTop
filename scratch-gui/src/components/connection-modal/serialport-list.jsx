...
const SerialportList = (props) => {
    ...
    useEffect(() => {
        ...
        return () => {
            window.myAPI.delEvents([
                ipc_Renderer.RETURN.COMMUNICATION.SOURCE.LENGTH,
                ipc_Renderer.RETURN.FILE.NAME,
            ]);
        };
    }, []);
    ...
    function getPortName(port) {
        return deviceType === verifyTypeConfig.BLUETOOTH
            ? `${port?.friendlyName || port?.localName} (${port?.address})`
        ...
        <Box className={styles.body}>
            ...
            >
                <Box
                    ...
                    style={{
                        justifyContent:
                            isShow || deviceType === verifyTypeConfig.BLUETOOTH
                                ? "flex-start"
                                : "center",
                        alignItems:
                            (isShow ||
                    ...
                    >
                        ...
                        >
                            {props.sourceCompleted ? (
                                ...
                                <>
                                    {props.version == props.firewareVersion ? (
                                        <FormattedMessage
