...
function ProjectMenu({
    ...
    function clickProgram(e) {
        if (e) {
            ...
            if (
                !programRef?.current?.contains(e.target) &&
                !e?.target?.classList?.contains(styles.profileIcon)
            ) {
                setDisplay("none");
                return;
            }
    ...
    return (
        <>
            <Box className={classNames(styles.menuBarItem, styles.growable)}>
